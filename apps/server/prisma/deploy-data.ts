...
// department data
const ADMIN_DEPARTMENT_UUID = uuidv4();

// position data
const ADMIN_POSITION_UUID = uuidv4();

// employee data
const ADMIN_UUID = uuidv4();
const ADMIN_SIGNATURE_LINK =
...
const HASHED_ADMIN_PASSWORD = hashSync(
  'mfaAdmin2025!',
  parseInt(process.env.SALT_ROUNDS || '10'),
);
export const departments: DepartmentData[] = [
  {
    id: ADMIN_DEPARTMENT_UUID,
    name: 'Admin',
  },
];
export const positions: PositionData[] = [
  {
    id: ADMIN_POSITION_UUID,
    name: 'Admin',
    departmentId: ADMIN_DEPARTMENT_UUID,
  },
];
...
export const employees: EmployeeData[] = [
  {
    ...
    signatureLink: ADMIN_SIGNATURE_LINK,
    scope: EmployeeScope.ADMIN,
    passwordHash: HASHED_ADMIN_PASSWORD,
    positionId: ADMIN_POSITION_UUID,
  },
];
