...
export class SignatureFieldsController {
  constructor(private readonly signatureFieldsService: SignatureFieldsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSignatureFieldDto: UpdateSignatureFieldDto) {
