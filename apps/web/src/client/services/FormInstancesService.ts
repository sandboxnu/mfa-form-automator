...
export class FormInstancesService {
   ...
   * @throws ApiError
   */
  public static formInstancesControllerFindAllAssignedToCurrentEmployee(): CancelablePromise<
    Array<FormInstanceEntity>
  > {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static formInstancesControllerFindAllCreatedByCurrentEmployee(): CancelablePromise<
    Array<FormInstanceEntity>
  > {
    return __request(OpenAPI, {
      method: 'GET',
