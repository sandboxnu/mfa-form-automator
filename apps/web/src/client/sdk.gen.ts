...
export const appControllerGetHello = <ThrowOnError extends boolean = false>(options?: Options<AppControllerGetHelloData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AppControllerGetHelloResponse, unknown, ThrowOnError>({
        url: '/api',
        ...options
    });
};

export const appControllerLogin = <ThrowOnError extends boolean = false>(options: Options<AppControllerLoginData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AppControllerLoginResponse, unknown, ThrowOnError>({
        url: '/api/auth/login',
        ...options,
        headers: {
...
export const appControllerRefresh = <ThrowOnError extends boolean = false>(options?: Options<AppControllerRefreshData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<AppControllerRefreshResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const appControllerLogout = <ThrowOnError extends boolean = false>(options?: Options<AppControllerLogoutData, ThrowOnError>) => {
...
export const employeesControllerCreate = <ThrowOnError extends boolean = false>(options: Options<EmployeesControllerCreateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<EmployeesControllerCreateResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const employeesControllerFindMe = <ThrowOnError extends boolean = false>(options?: Options<EmployeesControllerFindMeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<EmployeesControllerFindMeResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const employeesControllerRemove = <ThrowOnError extends boolean = false>(options: Options<EmployeesControllerRemoveData, ThrowOnError>) => {
...
export const positionsControllerRemove = <ThrowOnError extends boolean = false>(options: Options<PositionsControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
...
export const signatureFieldsControllerRemove = <ThrowOnError extends boolean = false>(options: Options<SignatureFieldsControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
...
export const signaturesControllerUpdateSignatureSigner = <ThrowOnError extends boolean = false>(options: Options<SignaturesControllerUpdateSignatureSignerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<SignaturesControllerUpdateSignatureSignerResponse, unknown, ThrowOnError>({
...
export const departmentsControllerRemove = <ThrowOnError extends boolean = false>(options: Options<DepartmentsControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
...
export const formInstancesControllerFindAllAssignedToCurrentEmployee = <ThrowOnError extends boolean = false>(options?: Options<FormInstancesControllerFindAllAssignedToCurrentEmployeeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<FormInstancesControllerFindAllAssignedToCurrentEmployeeResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const formInstancesControllerFindAllCreatedByCurrentEmployee = <ThrowOnError extends boolean = false>(options?: Options<FormInstancesControllerFindAllCreatedByCurrentEmployeeData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<FormInstancesControllerFindAllCreatedByCurrentEmployeeResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const formInstancesControllerRemove = <ThrowOnError extends boolean = false>(options: Options<FormInstancesControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
...
export const formInstancesControllerCompleteFormInstance = <ThrowOnError extends boolean = false>(options: Options<FormInstancesControllerCompleteFormInstanceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<FormInstancesControllerCompleteFormInstanceResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const formTemplatesControllerRemove = <ThrowOnError extends boolean = false>(options: Options<FormTemplatesControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<unknown, unknown, ThrowOnError>({
