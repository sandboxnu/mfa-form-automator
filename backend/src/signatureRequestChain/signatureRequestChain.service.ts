...
import { CreateSignatureRequestChainDto, SignatureRequestChainLinkDto } from "./signatureRequestChain.dto";
...
export class SignatureRequestChainService {
    ...
    async createSignatureRequestChain(createSignatureChainRequestDto: CreateSignatureRequestChainDto) {
        let lastSignatureRequestLink: SignatureRequestLink = null;
        let signatureChainLinkNext: SignatureChainLink = 
            await this.signatureChainService.getSignatureChainRootByFormId(createSignatureChainRequestDto.formId)
        let signatureChainLinkCurrent: SignatureChainLink = 
            await this.signatureChainService.getSignatureChainByNextSignatureId(signatureChainLinkNext.id)
        ...
        while (signatureChainLinkCurrent != null) {
          ...
          const signatureRequestChainLink: SignatureRequestLink =
            this.signatureRequestLinkRepository.create(signatureRequestChainLinkDto);
          ...
          signatureChainLinkCurrent = await this.signatureChainService.getSignatureChainByNextSignatureId(signatureChainLinkNext.id);
        }
